...
import 'package:project_aivia/presentation/screens/family/known_persons/known_persons_list_screen.dart';
import 'package:project_aivia/presentation/widgets/common/loading_indicator.dart';

/// Wrapper untuk Known Persons Tab dengan proper patient selection
class KnownPersonsTabWrapper extends ConsumerWidget {
  const KnownPersonsTabWrapper({super.key});
    ...
    return linkedPatientsAsync.when(
      data: (links) {
        ...
        if (linksWithProfiles.length == 1) {
          ...
          return KnownPersonsListScreen(patientId: patient.id);
        }
